    ...
    return (
        <div id="honors" className="mt-4 text-white">
            ...
            <div className="flex flex-col md:flex-row mt-4 gap-5">
                <HonorCard name="Robot Skills World Champions (WC)" issued="VEX Robotics" desc="Team with highest combined top Programming and top Driving Skills Challenge score (Robot Performance)." />
